...
async function getCatwomanReply(channelId, authorId, authorName, userMessage) {
  ...
  // تحديد صفة الشخص لإرسالها بوضوح داخل سياق الرسالة ليفهمه الـ AI
  ...
  try {
    ...
    // ================= 🔄 المترجم العكسي للإيموجيات الحقيقية =================
    // سيدي بروس، يمكنك استبدال الأرقام الافتراضية بالـ IDs الحقيقية لإيموجيات سيرفرك المخصصة
    ...
    // استبدال النص البرمجي بالإيموجي الفعلي ليظهر كصورة في الشات
